<?php /* C:\xampp\htdocs\Refugees\resources\views/style/services.blade.php */ ?>
<?php $__env->startSection('content'); ?>

<section class="hero-wrap hero-wrap-2 " style="background-image: url(<?php echo e(asset('refugee/images/serve.jpg')); ?>);" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
				...
				<div class="col-md-12 d-flex ftco-animate">
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" class="block-20" style="background-image: url(<?php echo e(asset('refugee/images/image_2.jpg')); ?>);">
		              </a>
		              <div class="text d-block pl-md-4">
		                ...
		                <h3 class="heading"><a href="<?php echo e(URL('/donation')); ?>">Donate now to help save and change children's lives</a></h3>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" class="block-20 " style="background-image: url(<?php echo e(asset('refugee/images/image_3.jpg')); ?>);">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                ...
		                <h3 class="heading"><a href="<?php echo e(URL('services/jobs')); ?>">Work with Us</a></h3>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" class="block-20" style="background-image: url(<?php echo e(asset('refugee/images/image_4.jpg')); ?>);">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                ...
		                <h3 class="heading"><a href="<?php echo e(URL('services/apartments')); ?>">Urban Housing For Refugees</a></h3>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" class="block-20" style="background-image: url(<?php echo e(asset('refugee/images/image_6.jpg')); ?>);">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">june 19, 2019</a></div>
		                ...
		                <h3 class="heading"><a href="<?php echo e(URL('/community')); ?>">Refugee Journey To Safety And Stability</a></h3>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <ul class="categories">
                <li><a href="<?php echo e(URL('services/jobs')); ?>">Jobs <span>(5)</span></a></li>
                <li><a href="<?php echo e(URL('services/apartments')); ?>">Apartments <span>(3)</span></a></li>
              </ul>
            </div>
