<?php /* C:\xampp\htdocs\Refugees\resources\views/style/community.blade.php */ ?>
...
<section class="hero-wrap hero-wrap-2" style="background-image: url(<?php echo e(asset('refugee/images/communityy.jpg')); ?>);" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-12 col-lg-4 d-flex">
    				...
    				<img style="width: 670px;5" src="<?php echo e(asset('refugee/images/community.jpg')); ?>">
    			</div>
...
<div class="orgs">
  ...
  <a href="https://www.facebook.com/Eritrean.Refugees.Egypt/" class="causes text-center">
    <div class="img" style="background-image: url(<?php echo e(asset('refugee/images/ea.jpg')); ?>);"></div>
    <h2>ERITREAN REFUGEES IN EGYPT</h2>
  </a>
  </div>
  <div class="item">
  <a href="https://www.facebook.com/UNHCREgypt/" class="causes text-center">
    <div class="img" style="background-image: url(<?php echo e(asset('refugee/images/un.jpg')); ?>);"></div>
    <h2>UNHCR Egypt</h2>
  </a>
  </div>
  <div class="item">
  <a href="https://www.facebook.com/refuge.egypt/?ref=br_rs" class="causes text-center">
    <div class="img" style="background-image: url(<?php echo e(asset('refugee/images/re.jpg')); ?>);"></div>
    <h2>Refugee Egypt </h2>
  </a>
  </div>
  <div class="item">
  <a href="https://www.facebook.com/Psycho-social-services-and-Training-Institute-in-cairo-psTIC-300797483611710/?epa=SEARCH_BOX" class="causes text-center">
    <div class="img" style="background-image: url(<?php echo e(asset('refugee/images/ps.jpg')); ?>);"></div>
  ...
  <a href="https://www.facebook.com/standrewsrefugeeservices/?__tn__=%2Cd%2CP-R&eid=ARDZT6BA1HgCZpi67V-Flmv5ub5zmd602Q_BAonfgZIhbquxM9yuL5j26EBjQ1ZRFMfy9ZJfevleQzF4" class="causes text-center">
    <div class="img" style="background-image: url(<?php echo e(asset('refugee/images/st.jpg')); ?>);"></div>
...
<div id="carouselExampleControls" style="height: 400px" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img style="height: 400px" class="d-block w-100" src="<?php echo e(asset('refugee/images/photo1.jpg')); ?>" alt="First slide">
    </div>
    <div class="carousel-item">
      <img style="height: 400px" class="d-block w-100" src="<?php echo e(asset('refugee/images/photo.jpg')); ?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img style="height: 400px" class="d-block w-100" src="<?php echo e(asset('refugee/images/three.jpg')); ?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img style="height: 400px" class="d-block w-100" src="<?php echo e(asset('refugee/images/two.jpg')); ?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img style="height: 400px" class="d-block w-100" src="<?php echo e(asset('refugee/images/five.jpg')); ?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img style="height: 400px" class="d-block w-100" src="<?php echo e(asset('refugee/images/four.jpg')); ?>" alt="Second slide">
    </div>
