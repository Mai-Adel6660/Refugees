<?php /* C:\xampp\htdocs\Refugees\resources\views/style/about.blade.php */ ?>
<?php $__env->startSection('content'); ?>

<section class="hero-wrap hero-wrap-2" style="background-image: url(<?php echo e(asset('refugee/images/image_5.jpg')); ?>);" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(<?php echo e(asset('refugee/images/about-1.jpg')); ?>);">
    				</div>
    			</div>
    ...
    <section class="ftco-mission">
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-4 py-4 py-md-5 img" style="background-image: url(<?php echo e(asset('refugee/images/bg_1.jpg')); ?>)"></div>
    		</div>
    	</div>
    </section>
