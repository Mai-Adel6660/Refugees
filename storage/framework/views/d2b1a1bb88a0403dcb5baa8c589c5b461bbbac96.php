<?php /* C:\xampp\htdocs\Refugees\resources\views/style/donation.blade.php */ ?>
...
<section class="hero-wrap hero-wrap-2" style="background-image: url(<?php echo e(asset('refugee/images/donate.jpg')); ?>);" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h2 class="mb-3 bread">Help Them </h2>
            <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo e(URL('/home')); ?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Donation <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="w3_agileits_qualifications">
                ...
                <div class="w3-agile1">
                  <div class="payment-w3ls">	
                    <img src="<?php echo e(URL('refugee/images/card.png')); ?>" alt=" " class="img-responsive">
                  </div>
                </div>
